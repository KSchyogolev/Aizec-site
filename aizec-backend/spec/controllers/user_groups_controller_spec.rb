...
RSpec.describe UserGroupsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new user_group" do

        post :create, params: {user_group: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(user_group_url(UserGroup.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new user_group" do
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the user_group" do
        user_group = UserGroup.create! valid_attributes
